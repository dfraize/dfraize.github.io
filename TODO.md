...
- [ ] **GitHub Dependabot vulnerabilities** — flagged 2 vulnerabilities on the default branch (1 high, 1 moderate) after the 2026-08-07 deploy push. Not yet investigated; likely in a devDependency chain (`puppeteer`, `live-server`, or `sharp`), same territory as the npm audit cleanup already done below. Check `https://github.com/dfraize/dfraize.github.io/security/dependabot` for specifics.
